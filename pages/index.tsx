...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Thierry De Belder | Web Developer</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={
            "Thierry De Belder - Software Development Engineer &amp; Product Developer"
          }
        />
        <meta
          name="description"
      ...
      <main className="w-full containerCenterImage">
        <div className="container w-full max-w-5xl p-6 mx-auto vscodecontainer mb:p-12">
          <div className="flex flex-col mt-1 md:flex-row md:space-x-4">
            <div className="flex-1 mb-4 md:mb-0 ">
              <div className="p-2">
                <h2 className="mb-2 font-sans text-5xl ">Thierry De Belder</h2>
                <h3 className="pt-1 mb-2 font-sans text-2xl text-gray-500">
                  Web Developer
                </h3>

                <p className="pt-5 mb-4 text-xl text-gray-300">Start</p>
                <Link passHref href="/Skills">
                  <p className="flex items-center justify-start gap-1 pb-2 font-sans text-sm text-blue-500 cursor-pointer">
                    <svg
                ...
                <p className="pt-6 mb-2 text-xl text-gray-300 ">Recent</p>
                {recentLinks?.length < 1 ? (
                  <p className="pt-1 font-sans text-sm text-gray-500">
                    No recent activity!
                  </p>
                ) : (
                  <div className="pt-1">
                    {recentLinks?.map((item: any, index: number) => (
                      <Link passHref href={item} key={`link-recent-${index}`}>
                        <p className="flex items-center justify-start gap-1 pb-2 font-sans text-sm text-blue-500 cursor-pointer">
                          {item?.slice(1)}{" "}
                          <p className="pl-2 text-sm text-gray-300 ">
                            E:/ThierryDeBelder{item}
                          </p>
                        </p>
                      </Link>
                    ))}
            ...
            <div className="flex-1 ">
              ...
              >
                <p className="pt-6 mb-1 text-xl text-gray-300 ">About</p>
                <div className="pt-1">
                  <Link
                    passHref
                    target="_blank"
                    href="https://www.linkedin.com/in/thierry-de-belder/"
                  >
                    <div
                      className="flex items-center justify-start w-full gap-2 p-1 pl-2 pr-2 border-b border-blue-500 rounded-sm cursor-pointer "
                      style={{
                ...
                <div className="mt-4">
                  <Link passHref target="_blank" href="https://github.com/selftaugthdev">
                    <div
                      className="flex items-center justify-start w-full gap-2 p-1 pl-2 pr-2 border-b border-blue-500 rounded-sm cursor-pointer "
                      style={{
                        backgroundColor: "#262626",
                ...
                <div className="mt-4">
                  <Link
                    passHref
                    target="_blank"
                    href="https://x.com/SelfTaughtDev__"
                  >
                    <div
                      className="flex items-center justify-start w-full gap-2 p-1 pl-2 pr-2 border-b border-blue-500 rounded-sm cursor-pointer "
                      style={{
                ...
                <div className="mt-4">
                  <div
                    className="flex items-center justify-start w-full gap-2 p-1 pl-2 pr-2 border-b border-blue-500 rounded-sm "
                    style={{
                      backgroundColor: "#262626",
                      borderBottomWidth: "0.3rem",
                    }}
                ...
                <div className="mt-4">
                  ...
                  >
                    <img
                      src="https://img.icons8.com/color/28/brain"
                      className="ml-1 mr-1"
                    />{" "}
                    <p className="flex items-center justify-start font-sans text-sm text-gray-200">
                      Life Long Learner
