...
const Gaming: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      {!isTabletOrMobile ? (
        <article className="pb-40 ml-3 text-left bg-center bg-no-repeat bg-cover scrollbar bg-app ">
          <section className="pt-10 pr-5">
            {/* <div className="pt-3 pr-3 animeplayer">
              {play ? (
                <img
                ...
                <div className="flex-1 p-4 lg:p-6">
                  <div className="flex items-center mb-4 text-lg text-white">
                    <div className="md:flex items-cente text0 ">
                      <h1 className="text-3xl font-bold leading-tight text-indigo-100 lg:text-5xl">
                        Gaming
                      </h1>
                    </div>
                  </div>
                  <div className="pb-4 text-green-400 font-small dark:text-green-400">
                    {" "}
                  ...
                  <div className="grid gap-4 grid-cols-1s xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                    <div className="relative flex flex-col p-4 bg-white rounded-2xl backdrop-filter backdrop-blur-lg bg-opacity-20 undefined">
                      ...
                      <div className="mt-4 mb-2 text-lg font-medium text-green-400">
                        Valorant
                      </div>
                      <div className="font-normal text-green-400">
        ...
        <article className="pb-40 text-left bg-center bg-no-repeat bg-cover scrollbar bg-app ">
          <section className="pt-10 ">
            ...
            <div className="flex flex-row items-center justify-center rounded-lg ">
              <main className="flex flex-col w-full mt-5 ml-1 mr-1 overflow-hidden lg:flex-row backdrop-filter backdrop-blur-md bg-opacity-20 rounded-xl ">
